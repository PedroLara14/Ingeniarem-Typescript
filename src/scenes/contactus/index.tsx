...
const ContactUs = ({ setSelectedPage }: Props) => {
    ...
    const inputStyles = `mb-5 w-full rounded-lg bg-primary-700 text-white px-5 py-3 placeholder-white`
  ...
  return <section id="contáctanos" className="mx-auto w-5/6 pt-24 pb-32">
    <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.ContactUs)}>
        ...
        >
            <HText>
                <span className="text-cyan-800">CONTÁCTANOS</span>
            </HText>
        </motion.div>
        ...
        <div className="mt-10 justify-between gap-8 md:flex">
            ...
            >
                ...
                >
                   ...
                   <button
                   type="submit"
                   className="mt-5 rounded-lg bg-primary-700 text-white px-20 py-3 transition duration-500 hover:text-white"
                   >
                    ENVIAR
                   </button>
                </form>
